        ...
        <header id="header" class="transparent-nav" style="position: fixed;background-color: #af0b00; top: 0;">
			<div class="container">
				...
				<div class="navbar-header">
					...
					<a href="main.php"><img src="img/hcdc_logo.png" alt="Logo" class="logo-img"></a>
						<a class="logo" href="main.php">HOLY CROSS OF <br> DAVAO COLLEGE</a>
					</div>
					<!-- /Logo -->
					...
					<ul class="main-menu nav navbar-nav navbar-right">
                        ...
                        <li class="dropdown">
                            ...
                            <div class="dropdown-content">
								<a href="http://127.0.0.1/php%20CAREERLY/login.php">Course Prediction</a>
